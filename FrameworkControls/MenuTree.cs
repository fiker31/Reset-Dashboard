                ...
                if (items.Parent == null)
                {
                    ...
                    switch (items.Text)
                    {
                        ...
                        case "Security":
                            ...
                            break;
                        case "My Salers":
                            parentMenuLinkIcon.Attributes["class"] = "nav-icon fa fa-user";
                            break;
                        default:
                            break;
                    }
                    ...
                    foreach (TreeNode item in items.ChildNodes)
                    {
                        ...
                        item.NavigateUrl = item.NavigateUrl.Contains(":8181") == true ? item.NavigateUrl.Replace(":8181", "") : item.NavigateUrl;
