<%@ Page Language="C#" MasterPageFile="~/Credit.master" AutoEventWireup="true" CodeFile="ActiveSalers.aspx.cs" Inherits="_ActiveSalers" Title="Salers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Active Salers</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row " style="overflow-x: auto">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12 m-0 p-0">
            <dx:ASPxGridView ID="ActiveSalers" runat="server" Width="100%" AutoGenerateColumns="False" EnableTheming="True" Theme="MaterialCompact">
