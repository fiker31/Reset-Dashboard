<%@ Page Language="C#" MasterPageFile="~/Credit.master" AutoEventWireup="true" CodeFile="Merchant_2023.aspx.cs" Inherits="_Merchant_2023" Title="Txn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row" style="overflow-x: auto">
        <div class="col-md-12 ">
            <dx:ASPxGridView ID="MerchantAppAllTxns" runat="server" CssClass="" Width="100%" AutoGenerateColumns="False" EnableTheming="True" Theme="MaterialCompact">
